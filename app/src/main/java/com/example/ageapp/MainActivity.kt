...
class MainActivity : AppCompatActivity() {
    @SuppressLint("CutPasteId", "WrongViewCast", "SuspiciousIndentation", "SetTextI18n")
...
//Declarations
      ...
      // checking the condition of the submit button, checking if it has been pressed or not
        submitButton?.setOnClickListener{
            ...
            if (age in 20..100) // checking if age is within range
            {

                    // A When/Switch/Case is used to match entered age to the famous person
                ...
                // output the text that was pulled from when statments
                    textOutput.text = matchAge
        }
            else //if age is not a whole number
                Toast.makeText(this, "Your age is not within 20 to 100 years old", Toast.LENGTH_SHORT).show()
